...
describe("Order service unit tests", () => {
  ...
  it("should get total of all orders", () => {
    ...
    const item3 = new OrderItem("3", "Item 3", 30, 3);
    const item4 = new OrderItem("4", "Item 4", 40, 4);
    const order2 = new Order("2", "1", [item3, item4]);

    const item5 = new OrderItem("5", "Item 5", 50, 5);
    const item6 = new OrderItem("6", "Item 6", 60, 6);
